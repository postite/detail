...
var command_Command1 = function(r) {
	haxe_Log.trace(r,{ fileName : "src/command/Command1.hx", lineNumber : 10, className : "command.Command1", methodName : "new"});
	this.remote = r;
};
...
cross_Config.configSwitch = ["192.168.1.34","localhost"];
cross_Config.localPort = 8080;
cross_Config.localIP = "192.168.1.34";
cross_Config.root = "./";
